...
export async function getServerSideProps(context) {
  ...
  const currentPageData = await loadHomePageData(
    getPageQuery(registeredPages.DETAILED_INDUSTRY_SERVICES, slug)
  );
...
const SeoIndustry = ({ currentPageData }) => {
  ...
  if (!isNotNull(seoIndustryVar)) return <h1>No Data Found</h1>;
  ...
  return (
    ...
    >
      ...
      <ImageWithSideIconContents
        ...
        buttonData={{
          buttonText:
            pageVars.industryServicesCtaButton1.industryServicesButtonLabel1,
          action:
            pageVars.industryServicesCtaButton1.industryServicesButtonLink1,
        }}
      ...
      <ImageWithSideContent
        ...
        buttonData={{
          buttonText:
            pageVars.industryServicesCtaButton2.industryServicesButtonLabel2,
          action:
            pageVars.industryServicesCtaButton2.industryServicesButtonLink2,
        }}
      />
      ...
      <FeaturesSection
        ...
        button={{
          buttonText:
            pageVars.industryServicesCtaButton3.industryServicesButtonLabel3,
          action:
            pageVars.industryServicesCtaButton3.industryServicesButtonLink3,
        }}
      ...
      <FeaturePowerUpComponent
        ...
        button={{
          buttonText:
            pageVars.industryServicesCtaButton5.industryServicesButtonLabel5,
          action:
            pageVars.industryServicesCtaButton5.industryServicesButtonLink5,
        }}
      ...
      <div className={"pt-5"}>
        <HeaderDescContainer
          ...
          buttonData={{
            buttonText:
              pageVars.industryServicesCtaButton4.industryServicesButtonLabel4,
            action:
              pageVars.industryServicesCtaButton4
                .industryServicesCtaButtonLink4,
          }}
        />
      </div>
      <VerticalSwiper
        sliderData={pageVars.industryServicesVerticalSlider.map((c) => {
          return {
            ...
            button: {
              buttonText:
                c.industryServicesVerticalSliderCtaButton
      ...
      <section className={"pt-5"}>
        <HeaderDescContainer
          ...
          buttonData={{
            buttonText:
              pageVars.industryServicesCardCta.industryServicesCardCtaLabel,
            action:
              pageVars.industryServicesCardCta.industryServicesCardCtaLink,
          }}
        />

        <div className="row">
          {pageVars.industryServicesCardComp.map((card, i) => (
            <div className="col-lg-4 col-md-6 col-sm-12 col-12" key={i}>
              <IconCardContainer
                ...
                listData={card.industryServicesCardPoints.map((c, i) => {
                  return {
                    servicePointName: c.industryServicesCardBulletPoints,
                  };
                })}
              />
            </div>
      ...
      {pageVars.industryServicesAltContentWithImage.map((card, index) => (
        <ImageWithSideContent
          ...
          buttonData={{
            buttonText:
              card.industryServicesCtaButton5.industryServicesButtonLabel5,
      ...
      <FaqQuestions
        ...
        buttonData={{
          buttonText:
            pageVars.industryServicesFaqCtaButton
