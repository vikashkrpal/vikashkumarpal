...
const HomePageContent = ({ currentPageData }) => {
  ...
  return (
    <Template currentPageData={currentPageData}>
      ...
      {checkNotUndefined(pageData.hpContentArea1) &&
        pageData.hpContentArea1.map((data, index) => (
          <ImageWithSideContent
      ...
      <div className="row align-items-center pt-5">
        ...
        <div className="col-lg-6 col-md-4 text-lg-center my-auto d-flex  lg:justify-content-end justify-content-lg-end">
