...
`;
  ...
  // console.log("res", JSON.stringify(res.industries.edges, null, 2));
  const timestamps = getUpdatedDates(res.industries.edges.length);
  return res.industries.edges.map(({ node }, index) => ({
